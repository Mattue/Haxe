...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Company Name", "OpenFLProject11", "com.example.openflproject11", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "OpenFLProject11", null, { width: 800, height: 600 });
